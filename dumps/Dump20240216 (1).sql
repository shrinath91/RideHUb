...
CREATE TABLE `rides` (
  ...
  PRIMARY KEY (`rideId`),
  KEY `ride_driver_id_idx` (`ride_driver_id`),
  CONSTRAINT `ride_driver_id` FOREIGN KEY (`ride_driver_id`) REFERENCES `drivers` (`driver_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'vaishnavi','vaishnavi@123',1,1),(2,'shrinath','shri@123',2,1),(3,'omkar','omakar@123',3,0),(53,'Ashlesha','ash@1234',2,1),(54,'Uday','Uday@12343',2,0);
...
-- Dump completed on 2024-02-16 18:41:00
